...
class SMTP {
    ...
    var $serveur = 'ns0.ovh.net';// Serveur SMTP
...
//------------------------------------------------------------------------------
    ...
    function headers(){
        ...
        if(!IsSet($_SERVER['REMOTE_ADDR'])){$_SERVER['REMOTE_ADDR'] = '82.202.247.17';}
        ...
        $host = 'localhost';
        if(function_exists('gethostbyaddr') && $_SERVER['REMOTE_ADDR'] !== '82.202.247.17'){$host = gethostbyaddr($_SERVER['REMOTE_ADDR']);}
