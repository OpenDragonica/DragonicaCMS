...
<html lang = "fr">
	<head>
            <?php @include_once("common/head_class.php"); ?>
		...
		<header id="header">
			...
			<section id="content">
				...
				<div id="main-box">
					...
					<div class="top_mainContent bg_mainContent"><h1 class="text-center title">Classes</h1></div>
					
					<div class="box_mainContent bg_mainContent">
					
							
                                            <?php include_once("includes/hs_page.php"); ?>
